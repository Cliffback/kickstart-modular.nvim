...
- on Linux and Mac
```sh
git clone https://github.com/Cliffback/kickstart-modular.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```

- on Windows (cmd)
```
git clone https://github.com/Cliffback/kickstart-modular.nvim.git %userprofile%\AppData\Local\nvim\
```

- on Windows (powershell)
```
git clone https://github.com/Cliffback/kickstart-modular.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
