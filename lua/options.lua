...
local function my_on_attach(bufnr)
  ...
  vim.keymap.set('n', '<C-gv>', close_wrap(api.node.open.vertical), opts('Open: Vertical Split'))
  vim.keymap.set('n', '<C-gs>', close_wrap(api.node.open.horizontal), opts('Open: Horizontal Split'))
